  ...
  render () {
    ...
    if (this.state.tab == 'logs'){
      ...
      function highlight(input){
        ...
        var bashColors = [
        [/\[(0;)?30m(.*?)\[(0)?m/g, '<span class="black">$1</span>'],
        [/\[(0;)?31m(.*?)\[(0)?m/g, '<span class="red">$1</span>'],
        [/\[(0;)?32m(.*?)\[(0)?m/g, '<span class="green">$1</span>'],
        [/\[(0;)?33m(.*?)\[(0)?m/g, '<span class="brown">$1</span>'],
        [/\[(0;)?34m(.*?)\[(0)?m/g, '<span class="blue">$1</span>'],
        [/\[(0;)?35m(.*?)\[(0)?m/g, '<span class="purple">$1</span>'],
        [/\[(0;)?36m(.*?)\[(0)?m/g, '<span class="cyan">$1</span>'],
        [/\[(0;)?37m(.*?)\[(0)?m/g, '<span class="light-gray">$1</span>'],
